...
<?php print $extra_config; ?>
  ...
  # Additional host wide configuration settings. The Backdrop chain head,
  # /data/conf/global/global-bd.inc (deployed by the BOA global-config layer),
  # runs the same BOA partials as the per-core Drupal heads -- the control
  # INI files, the mode gates and the /data/conf override hooks -- with the
  # Backdrop-specific Valkey wiring in place of the Drupal one. Include it
  # only if present, with NO fallback to the legacy /data/conf/global.inc
  # dispatcher (which would route here anyway).
